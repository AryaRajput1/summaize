...
function PricingSection() {
  return (
    <div
      className="w-full flex flex-col gap-4 justify-center items-center my-4 py-8"
      id="price"
    >
          ...
          return (
            ...
            >
              ...
              <Link
                href={plan.link}
                className={cn(
                  "bg-gradient-to-r from-rose-400 to-rose-500 rounded-4xl flex items-center justify-center p-2 text-white gap-2 font-bold",
                  plan.recommended &&
                    "from-rose-700 to-rose-400 border border-rose-800"
                )}
              >
                Buy Now <ArrowRight />
              </Link>
